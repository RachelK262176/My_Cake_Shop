...
void main() => runApp(NewCakeScreen());

class NewCakeScreen extends StatefulWidget {
  final User user;
  final Cake cake;

  const NewCakeScreen({Key key, this.user, this.cake}) : super(key: key);

  @override
  _NewCakeScreenState createState() => _NewCakeScreenState();
}

class _NewCakeScreenState extends State<NewCakeScreen> {
